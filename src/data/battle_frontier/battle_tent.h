...
const struct FacilityMon gSlateportBattleTentMons[NUM_SLATEPORT_TENT_MONS] =
{
    [SLATEPORT_TENT_MON_ZIGZAGOON_1] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_GROWL, MOVE_LEER, MOVE_PIN_MISSILE},
    ...
    [SLATEPORT_TENT_MON_ZIGZAGOON_2] = {
        .species = SPECIES_ZIGZAGOON,
        .moves = {MOVE_DIG, MOVE_SAND_ATTACK, MOVE_TAIL_WHIP, MOVE_REST},
    ...
    [SLATEPORT_TENT_MON_DUSTOX] = {
        ...
        .moves = {MOVE_POISON_STING, MOVE_RECOVER, MOVE_HARDEN, MOVE_GUST},
    ...
    [SLATEPORT_TENT_MON_WAILMER_1] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_GROWL, MOVE_GROWL, MOVE_WRAP},
    ...
    [SLATEPORT_TENT_MON_WAILMER_2] = {
        .species = SPECIES_WAILMER,
        .moves = {MOVE_TACKLE, MOVE_GROWL, MOVE_WRAP, MOVE_WATER_GUN},
    ...
    [SLATEPORT_TENT_MON_MARILL_1] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_DEFENSE_CURL, MOVE_TAIL_WHIP, MOVE_BUBBLE_BEAM},
    ...
    [SLATEPORT_TENT_MON_WINGULL_1] = {
        ...
        .moves = {MOVE_SUPERSONIC, MOVE_GROWL, MOVE_WING_ATTACK, MOVE_WING_ATTACK},
    ...
    [SLATEPORT_TENT_MON_PELIPPER_1] = {
        ...
        .moves = {MOVE_GUST, MOVE_WATER_GUN, MOVE_GROWL, MOVE_WING_ATTACK},
    ...
    [SLATEPORT_TENT_MON_CACNEA_1] = {
        ...
        .moves = {MOVE_SAND_ATTACK, MOVE_LEER, MOVE_LEECH_SEED, MOVE_PIN_MISSILE},
    ...
    [SLATEPORT_TENT_MON_LOMBRE_1] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_WATER_GUN, MOVE_QUICK_ATTACK, MOVE_ABSORB},
    ...
    [SLATEPORT_TENT_MON_LOTAD] = {
        ...
        .moves = {MOVE_RECOVER, MOVE_METRONOME, MOVE_MIST, MOVE_MEGA_DRAIN},
    ...
    [SLATEPORT_TENT_MON_SEEDOT] = {
        ...
        .moves = {MOVE_LIGHT_SCREEN, MOVE_RECOVER, MOVE_LEECH_SEED, MOVE_BIDE},
    ...
    [SLATEPORT_TENT_MON_NUZLEAF] = {
        ...
        .moves = {MOVE_QUICK_ATTACK, MOVE_METRONOME, MOVE_HARDEN, MOVE_LOVELY_KISS},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
    ...
    [SLATEPORT_TENT_MON_NINJASK_1] = {
        ...
        .moves = {MOVE_FURY_SWIPES, MOVE_SCREECH, MOVE_SWORDS_DANCE, MOVE_DOUBLE_TEAM},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
    ...
    [SLATEPORT_TENT_MON_NINJASK_2] = {
        .species = SPECIES_NINJASK,
        .moves = {MOVE_FURY_SWIPES, MOVE_DOUBLE_TEAM, MOVE_SCREECH, MOVE_SAND_ATTACK},
    ...
    [SLATEPORT_TENT_MON_GRAVELER] = {
        ...
        .moves = {MOVE_SAND_ATTACK, MOVE_BIND, MOVE_ROCK_THROW, MOVE_EARTHQUAKE},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
    ...
    [SLATEPORT_TENT_MON_BALTOY] = {
        ...
        .moves = {MOVE_SELF_DESTRUCT, MOVE_ROCK_THROW, MOVE_PSYBEAM, MOVE_REFLECT},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
    ...
    [SLATEPORT_TENT_MON_MIGHTYENA_1] = {
        ...
        .moves = {MOVE_BITE, MOVE_ROAR, MOVE_CONFUSE_RAY, MOVE_TACKLE},
    ...
    [SLATEPORT_TENT_MON_MIGHTYENA_2] = {
        .species = SPECIES_MIGHTYENA,
        .moves = {MOVE_LEER, MOVE_GROWL, MOVE_SAND_ATTACK, MOVE_BITE},
    ...
    [SLATEPORT_TENT_MON_LINOONE] = {
        ...
        .moves = {MOVE_HEADBUTT, MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_REST},
    ...
    [SLATEPORT_TENT_MON_GOLDEEN] = {
        ...
        .moves = {MOVE_WATER_GUN, MOVE_HORN_ATTACK, MOVE_WATERFALL, MOVE_SUPERSONIC},
    ...
    [SLATEPORT_TENT_MON_ELECTRIKE_1] = {
        ...
        .moves = {MOVE_BITE, MOVE_THUNDER_SHOCK, MOVE_ROAR, MOVE_FLASH},
    ...
    [SLATEPORT_TENT_MON_VOLTORB] = {
        ...
        .moves = {MOVE_THUNDER_SHOCK, MOVE_TACKLE, MOVE_THUNDER_WAVE, MOVE_SCREECH},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
    ...
    [SLATEPORT_TENT_MON_ARON_1] = {
        ...
        .moves = {MOVE_DIG, MOVE_SCRATCH, MOVE_HARDEN, MOVE_COUNTER},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_NAUGHTY
    },
    [SLATEPORT_TENT_MON_ARON_2] = {
        .species = SPECIES_ARON,
        .moves = {MOVE_SAND_ATTACK, MOVE_SLAM, MOVE_HARDEN, MOVE_ROAR},
    ...
    [SLATEPORT_TENT_MON_TRAPINCH_1] = {
        ...
        .moves = {MOVE_BODY_SLAM, MOVE_FOCUS_ENERGY, MOVE_WRAP, MOVE_SAND_ATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_BRAVE
    },
    [SLATEPORT_TENT_MON_CACNEA_2] = {
        .species = SPECIES_CACNEA,
        .moves = {MOVE_LEECH_SEED, MOVE_SAND_ATTACK, MOVE_POISON_STING, MOVE_SELF_DESTRUCT},
    ...
    [SLATEPORT_TENT_MON_TAILLOW] = {
        ...
        .moves = {MOVE_GROWL, MOVE_WING_ATTACK, MOVE_AGILITY, MOVE_COUNTER},
    ...
    [SLATEPORT_TENT_MON_GOLBAT_1] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_GUST, MOVE_LEER, MOVE_CONFUSE_RAY},
    ...
    [SLATEPORT_TENT_MON_LOUDRED] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_SCREECH, MOVE_SCREECH, MOVE_SUPERSONIC},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [SLATEPORT_TENT_MON_SPINDA] = {
        ...
        .moves = {MOVE_DIZZY_PUNCH, MOVE_TACKLE, MOVE_HYPNOSIS, MOVE_REST},
    ...
    [SLATEPORT_TENT_MON_MAGNEMITE] = {
        ...
        .moves = {MOVE_SCREECH, MOVE_SUPERSONIC, MOVE_THUNDER_WAVE, MOVE_THUNDER_SHOCK},
    ...
    [SLATEPORT_TENT_MON_WHISMUR] = {
        ...
        .moves = {MOVE_REST, MOVE_REST, MOVE_GROWL, MOVE_BODY_SLAM},
    ...
    [SLATEPORT_TENT_MON_MAKUHITA] = {
        ...
        .moves = {MOVE_SAND_ATTACK, MOVE_SCRATCH, MOVE_COMET_PUNCH, MOVE_SWORDS_DANCE},
    ...
    [SLATEPORT_TENT_MON_BARBOACH] = {
        ...
        .moves = {MOVE_EARTHQUAKE, MOVE_SAND_ATTACK, MOVE_WATER_GUN, MOVE_WATER_GUN},
    ...
    [SLATEPORT_TENT_MON_VIGOROTH] = {
        ...
        .moves = {MOVE_FOCUS_ENERGY, MOVE_FURY_SWIPES, MOVE_HARDEN, MOVE_HYPNOSIS},
    ...
    [SLATEPORT_TENT_MON_MAGIKARP] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_THRASH, MOVE_SPLASH, MOVE_NONE},
    ...
    [SLATEPORT_TENT_MON_SEVIPER_1] = {
        ...
        .moves = {MOVE_LICK, MOVE_BITE, MOVE_GLARE, MOVE_WRAP},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
    ...
    [SLATEPORT_TENT_MON_KECLEON_1] = {
        ...
        .moves = {MOVE_PSYBEAM, MOVE_SUBSTITUTE, MOVE_SCRATCH, MOVE_TAIL_WHIP},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    [SLATEPORT_TENT_MON_KECLEON_2] = {
        .species = SPECIES_KECLEON,
        .moves = {MOVE_TACKLE, MOVE_TACKLE, MOVE_LICK, MOVE_SCREECH},
    ...
    [SLATEPORT_TENT_MON_LOMBRE_2] = {
        .species = SPECIES_LOMBRE,
        .moves = {MOVE_METRONOME, MOVE_TACKLE, MOVE_GROWL, MOVE_ABSORB},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_LONELY
    },
    [SLATEPORT_TENT_MON_NUMEL_2] = {
        .species = SPECIES_NUMEL,
        .moves = {MOVE_EMBER, MOVE_GROWL, MOVE_EARTHQUAKE, MOVE_LIGHT_SCREEN},
    ...
    [SLATEPORT_TENT_MON_TRAPINCH_2] = {
        .species = SPECIES_TRAPINCH,
        .moves = {MOVE_TACKLE, MOVE_DIG, MOVE_BITE, MOVE_QUICK_ATTACK},
    ...
    [SLATEPORT_TENT_MON_WINGULL_2] = {
        .species = SPECIES_WINGULL,
        .moves = {MOVE_WATER_GUN, MOVE_SUPERSONIC, MOVE_GROWL, MOVE_ICE_BEAM},
    ...
    [SLATEPORT_TENT_MON_MARILL_2] = {
        .species = SPECIES_MARILL,
        .moves = {MOVE_DOUBLE_EDGE, MOVE_MIST, MOVE_TAIL_WHIP, MOVE_WATER_GUN},
    ...
    [SLATEPORT_TENT_MON_SKITTY] = {
        ...
        .moves = {MOVE_METRONOME, MOVE_LOVELY_KISS, MOVE_SING, MOVE_GROWL},
    ...
    [SLATEPORT_TENT_MON_SEVIPER_2] = {
        .species = SPECIES_SEVIPER,
        .moves = {MOVE_CONFUSE_RAY, MOVE_WRAP, MOVE_POISON_STING, MOVE_HAZE},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_BRAVE
    },
    [SLATEPORT_TENT_MON_GOLBAT_2] = {
        .species = SPECIES_GOLBAT,
        .moves = {MOVE_BITE, MOVE_DISABLE, MOVE_SCREECH, MOVE_BITE},
    ...
    [SLATEPORT_TENT_MON_SANDSHREW] = {
        ...
        .moves = {MOVE_SLASH, MOVE_SAND_ATTACK, MOVE_WRAP, MOVE_DEFENSE_CURL},
    ...
    [SLATEPORT_TENT_MON_SWALOT] = {
        ...
        .moves = {MOVE_HYPNOSIS, MOVE_SLUDGE, MOVE_DISABLE, MOVE_POUND},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_IMPISH
    },
    ...
    [SLATEPORT_TENT_MON_ILLUMISE] = {
        ...
        .moves = {MOVE_GROWL, MOVE_TACKLE, MOVE_DISABLE, MOVE_RECOVER},
    ...
    [SLATEPORT_TENT_MON_KIRLIA] = {
        ...
        .moves = {MOVE_MEDITATE, MOVE_CONFUSION, MOVE_DOUBLE_TEAM, MOVE_GROWL},
    ...
    [SLATEPORT_TENT_MON_PLUSLE_1] = {
        ...
        .moves = {MOVE_THUNDER_SHOCK, MOVE_DISABLE, MOVE_THUNDER_WAVE, MOVE_GROWL},
    ...
    [SLATEPORT_TENT_MON_PLUSLE_2] = {
        .species = SPECIES_PLUSLE,
        .moves = {MOVE_THUNDER_SHOCK, MOVE_LEER, MOVE_SUBSTITUTE, MOVE_QUICK_ATTACK},
    ...
    [SLATEPORT_TENT_MON_ELECTRIKE_2] = {
        .species = SPECIES_ELECTRIKE,
        .moves = {MOVE_THUNDER_SHOCK, MOVE_THUNDER_WAVE, MOVE_ROAR, MOVE_THUNDER_WAVE},
    ...
    [SLATEPORT_TENT_MON_SWABLU] = {
        ...
        .moves = {MOVE_SING, MOVE_PECK, MOVE_WING_ATTACK, MOVE_LIGHT_SCREEN},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_JOLLY
    },
    [SLATEPORT_TENT_MON_MACHOP] = {
        ...
        .moves = {MOVE_FOCUS_ENERGY, MOVE_SEISMIC_TOSS, MOVE_SEISMIC_TOSS, MOVE_LEER},
    ...
    [SLATEPORT_TENT_MON_MACHOKE] = {
        ...
        .moves = {MOVE_FOCUS_ENERGY, MOVE_LEER, MOVE_KARATE_CHOP, MOVE_LEER},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    }
...
const struct FacilityMon gVerdanturfBattleTentMons[NUM_VERDANTURF_TENT_MONS] =
{
    [VERDANTURF_TENT_MON_POOCHYENA] = {
        ...
        .moves = {MOVE_ROAR, MOVE_SCRATCH, MOVE_BITE, MOVE_GROWL},
        .itemTableId = BATTLE_FRONTIER_ITEM_BLACK_GLASSES,
    ...
    [VERDANTURF_TENT_MON_ZIGZAGOON] = {
        .species = SPECIES_ZIGZAGOON,
        .moves = {MOVE_TACKLE, MOVE_GROWL, MOVE_PIN_MISSILE, MOVE_SAND_ATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [VERDANTURF_TENT_MON_DUSTOX] = {
        .species = SPECIES_DUSTOX,
        .moves = {MOVE_CONFUSION, MOVE_RECOVER, MOVE_HARDEN, MOVE_FLASH},
        .itemTableId = BATTLE_FRONTIER_ITEM_SILVER_POWDER,
    ...
    [VERDANTURF_TENT_MON_MACHOP] = {
        .species = SPECIES_MACHOP,
        .moves = {MOVE_LOW_KICK, MOVE_LEER, MOVE_FOCUS_ENERGY, MOVE_DISABLE},
        .itemTableId = BATTLE_FRONTIER_ITEM_PERSIM_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_LONELY
    },
    [VERDANTURF_TENT_MON_MAGIKARP] = {
        .species = SPECIES_MAGIKARP,
        .moves = {MOVE_SPLASH, MOVE_THRASH, MOVE_TACKLE, MOVE_NONE},
        .itemTableId = BATTLE_FRONTIER_ITEM_SILK_SCARF,
        .evSpread = F_EV_SPREAD_ATTACK,
        .nature = NATURE_HARDY
    },
    [VERDANTURF_TENT_MON_BARBOACH] = {
        .species = SPECIES_BARBOACH,
        .moves = {MOVE_SAND_ATTACK, MOVE_WATER_GUN, MOVE_MIST, MOVE_THUNDER_SHOCK},
        .itemTableId = BATTLE_FRONTIER_ITEM_ASPEAR_BERRY,
        .evSpread = F_EV_SPREAD_SPEED,
        .nature = NATURE_HASTY
    },
    [VERDANTURF_TENT_MON_WINGULL] = {
        .species = SPECIES_WINGULL,
        .moves = {MOVE_LOVELY_KISS, MOVE_GUST, MOVE_WING_ATTACK, MOVE_SUPERSONIC},
        .itemTableId = BATTLE_FRONTIER_ITEM_DRAGON_FANG,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_IMPISH
    },
    [VERDANTURF_TENT_MON_ARON_1] = {
        .species = SPECIES_ARON,
        .moves = {MOVE_COUNTER, MOVE_SCRATCH, MOVE_TACKLE, MOVE_LOVELY_KISS},
        .itemTableId = BATTLE_FRONTIER_ITEM_PECHA_BERRY,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_HARDY
    },
    [VERDANTURF_TENT_MON_NUMEL_1] = {
        .species = SPECIES_NUMEL,
        .moves = {MOVE_EMBER, MOVE_ROCK_SLIDE, MOVE_TACKLE, MOVE_GROWL},
        .itemTableId = BATTLE_FRONTIER_ITEM_CHARCOAL,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_SASSY
    },
    [VERDANTURF_TENT_MON_SWALOT] = {
        .species = SPECIES_SWALOT,
        .moves = {MOVE_HYPNOSIS, MOVE_SLUDGE, MOVE_ACID_ARMOR, MOVE_AMNESIA},
        .itemTableId = BATTLE_FRONTIER_ITEM_POISON_BARB,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_BOLD
    },
    [VERDANTURF_TENT_MON_KECLEON] = {
        .species = SPECIES_KECLEON,
        .moves = {MOVE_SUBSTITUTE, MOVE_TACKLE, MOVE_DOUBLE_TEAM, MOVE_BIND},
        .itemTableId = BATTLE_FRONTIER_ITEM_LAX_INCENSE,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_QUIET
    },
    [VERDANTURF_TENT_MON_BALTOY] = {
        .species = SPECIES_BALTOY,
        .moves = {MOVE_SAND_ATTACK, MOVE_FLASH, MOVE_SELF_DESTRUCT, MOVE_HARDEN},
        .itemTableId = BATTLE_FRONTIER_ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_NAUGHTY
    },
    ...
    [VERDANTURF_TENT_MON_MAKUHITA] = {
        .species = SPECIES_MAKUHITA,
        .moves = {MOVE_HARDEN, MOVE_COMET_PUNCH, MOVE_MEGA_PUNCH, MOVE_SAND_ATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_SALAC_BERRY,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_NAUGHTY
    },
    [VERDANTURF_TENT_MON_SWABLU] = {
        .species = SPECIES_SWABLU,
        .moves = {MOVE_RECOVER, MOVE_LIGHT_SCREEN, MOVE_LOVELY_KISS, MOVE_MIRROR_MOVE},
        .itemTableId = BATTLE_FRONTIER_ITEM_BRIGHT_POWDER,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MILD
    },
    [VERDANTURF_TENT_MON_GOLDEEN_1] = {
        .species = SPECIES_GOLDEEN,
        .moves = {MOVE_WATERFALL, MOVE_SAND_ATTACK, MOVE_SUPERSONIC, MOVE_DOUBLE_TEAM},
        .itemTableId = BATTLE_FRONTIER_ITEM_MYSTIC_WATER,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
    ...
    [VERDANTURF_TENT_MON_LOTAD] = {
        .species = SPECIES_LOTAD,
        .moves = {MOVE_GROWL, MOVE_WATER_GUN, MOVE_MEGA_DRAIN, MOVE_HARDEN},
        .itemTableId = BATTLE_FRONTIER_ITEM_IAPAPA_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [VERDANTURF_TENT_MON_NUMEL_2] = {
        .species = SPECIES_NUMEL,
        .moves = {MOVE_EARTHQUAKE, MOVE_EMBER, MOVE_GROWL, MOVE_DEFENSE_CURL},
        .itemTableId = BATTLE_FRONTIER_ITEM_CHARCOAL,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_RELAXED
    },
    [VERDANTURF_TENT_MON_LINOONE] = {
        .species = SPECIES_LINOONE,
        .moves = {MOVE_HEADBUTT, MOVE_GROWL, MOVE_HARDEN, MOVE_REST},
        .itemTableId = BATTLE_FRONTIER_ITEM_QUICK_CLAW,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_IMPISH
    },
    [VERDANTURF_TENT_MON_SEVIPER] = {
        .species = SPECIES_SEVIPER,
        .moves = {MOVE_WRAP, MOVE_GLARE, MOVE_BITE, MOVE_CONFUSE_RAY},
        .itemTableId = BATTLE_FRONTIER_ITEM_ASPEAR_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_LONELY
    },
    [VERDANTURF_TENT_MON_SKARMORY] = {
        ...
        .moves = {MOVE_GUST, MOVE_SAND_ATTACK, MOVE_LEER, MOVE_AGILITY},
    ...
    [VERDANTURF_TENT_MON_GOLDEEN_2] = {
        .species = SPECIES_GOLDEEN,
        .moves = {MOVE_PECK, MOVE_SUPERSONIC, MOVE_PSYBEAM, MOVE_MIST},
    ...
    [VERDANTURF_TENT_MON_ELECTRIKE] = {
        .species = SPECIES_ELECTRIKE,
        .moves = {MOVE_THUNDERBOLT, MOVE_TACKLE, MOVE_THUNDER_WAVE, MOVE_THUNDER_WAVE},
        .itemTableId = BATTLE_FRONTIER_ITEM_FOCUS_BAND,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_MILD
    },
    [VERDANTURF_TENT_MON_NUZLEAF] = {
        .species = SPECIES_NUZLEAF,
        .moves = {MOVE_LIGHT_SCREEN, MOVE_DISABLE, MOVE_QUICK_ATTACK, MOVE_SCRATCH},
        .itemTableId = BATTLE_FRONTIER_ITEM_BLACK_GLASSES,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_BOLD
    },
    [VERDANTURF_TENT_MON_ARON_2] = {
        .species = SPECIES_ARON,
        .moves = {MOVE_TAKE_DOWN, MOVE_SCRATCH, MOVE_HARDEN, MOVE_LOVELY_KISS},
        .itemTableId = BATTLE_FRONTIER_ITEM_QUICK_CLAW,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    [VERDANTURF_TENT_MON_MIGHTYENA] = {
        .species = SPECIES_MIGHTYENA,
        .moves = {MOVE_GROWL, MOVE_TAKE_DOWN, MOVE_LEER, MOVE_SAND_ATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_KINGS_ROCK,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    ...
    [VERDANTURF_TENT_MON_GRAVELER] = {
        .species = SPECIES_GRAVELER,
        .moves = {MOVE_TACKLE, MOVE_ROCK_THROW, MOVE_SAND_ATTACK, MOVE_BIND},
        .itemTableId = BATTLE_FRONTIER_ITEM_FOCUS_BAND,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_IMPISH
    },
    [VERDANTURF_TENT_MON_KADABRA] = {
        .species = SPECIES_KADABRA,
        .moves = {MOVE_DISABLE, MOVE_PSYBEAM, MOVE_DISABLE, MOVE_KINESIS},
        .itemTableId = BATTLE_FRONTIER_ITEM_FOCUS_BAND,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    [VERDANTURF_TENT_MON_VOLTORB] = {
        .species = SPECIES_VOLTORB,
        .moves = {MOVE_HARDEN, MOVE_SELF_DESTRUCT, MOVE_THUNDER_SHOCK, MOVE_SCREECH},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_BASHFUL
    },
    [VERDANTURF_TENT_MON_MAGNEMITE] = {
        .species = SPECIES_MAGNEMITE,
        .moves = {MOVE_SCREECH, MOVE_SUPERSONIC, MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT},
        .itemTableId = BATTLE_FRONTIER_ITEM_MAGNET,
    ...
    [VERDANTURF_TENT_MON_PELIPPER] = {
        .species = SPECIES_PELIPPER,
        .moves = {MOVE_WING_ATTACK, MOVE_MIST, MOVE_AGILITY, MOVE_HARDEN},
        .itemTableId = BATTLE_FRONTIER_ITEM_FIGY_BERRY,
        .evSpread = 0,
        .nature = NATURE_BRAVE
    },
    [VERDANTURF_TENT_MON_LOUDRED] = {
        .species = SPECIES_LOUDRED,
        .moves = {MOVE_GROWL, MOVE_SCREECH, MOVE_REST, MOVE_SCREECH},
        .itemTableId = BATTLE_FRONTIER_ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_CALM
    },
    ...
    [VERDANTURF_TENT_MON_TRAPINCH] = {
        .species = SPECIES_TRAPINCH,
        .moves = {MOVE_DIG, MOVE_ROCK_THROW, MOVE_SAND_ATTACK, MOVE_TACKLE},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_NAUGHTY
    },
    [VERDANTURF_TENT_MON_TENTACOOL] = {
        .species = SPECIES_TENTACOOL,
        .moves = {MOVE_SCREECH, MOVE_CONFUSE_RAY, MOVE_WRAP, MOVE_LOVELY_KISS},
        .itemTableId = BATTLE_FRONTIER_ITEM_BRIGHT_POWDER,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    [VERDANTURF_TENT_MON_VIGOROTH] = {
        .species = SPECIES_VIGOROTH,
        .moves = {MOVE_DISABLE, MOVE_REST, MOVE_HYPNOSIS, MOVE_SWIFT},
        .itemTableId = BATTLE_FRONTIER_ITEM_MENTAL_HERB,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_QUIRKY
    },
    [VERDANTURF_TENT_MON_WAILMER] = {
        .species = SPECIES_WAILMER,
        .moves = {MOVE_WATER_GUN, MOVE_TACKLE, MOVE_GROWL, MOVE_HARDEN},
        .itemTableId = BATTLE_FRONTIER_ITEM_WHITE_HERB,
    ...
    [VERDANTURF_TENT_MON_ILLUMISE] = {
        .species = SPECIES_ILLUMISE,
        .moves = {MOVE_TACKLE, MOVE_GROWL, MOVE_RECOVER, MOVE_DISABLE},
        .itemTableId = BATTLE_FRONTIER_ITEM_BRIGHT_POWDER,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [VERDANTURF_TENT_MON_MACHOKE] = {
        .species = SPECIES_MACHOKE,
        .moves = {MOVE_LEER, MOVE_KARATE_CHOP, MOVE_HARDEN, MOVE_REST},
        .itemTableId = BATTLE_FRONTIER_ITEM_CHESTO_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_CALM
    },
    [VERDANTURF_TENT_MON_WHISMUR] = {
        .species = SPECIES_WHISMUR,
        .moves = {MOVE_SWIFT, MOVE_SUPERSONIC, MOVE_STOMP, MOVE_ROAR},
        .itemTableId = BATTLE_FRONTIER_ITEM_RAWST_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_QUIRKY
    },
    [VERDANTURF_TENT_MON_CACNEA] = {
        .species = SPECIES_CACNEA,
        .moves = {MOVE_LEECH_SEED, MOVE_LEECH_SEED, MOVE_PIN_MISSILE, MOVE_GROWTH},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_SERIOUS
    }
...
const struct FacilityMon gFallarborBattleTentMons[NUM_FALLARBOR_TENT_MONS] =
{
    [FALLARBOR_TENT_MON_NUMEL] = {
        .species = SPECIES_NUMEL,
        .moves = {MOVE_GROWL, MOVE_FLAMETHROWER, MOVE_TACKLE, MOVE_LIGHT_SCREEN},
        .itemTableId = BATTLE_FRONTIER_ITEM_CHARCOAL,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    [FALLARBOR_TENT_MON_LINOONE_1] = {
        .species = SPECIES_LINOONE,
        .moves = {MOVE_LEER, MOVE_TACKLE, MOVE_ROCK_THROW, MOVE_GROWL},
        .itemTableId = BATTLE_FRONTIER_ITEM_SILK_SCARF,
    ...
    [FALLARBOR_TENT_MON_PLUSLE] = {
        .species = SPECIES_PLUSLE,
        .moves = {MOVE_THUNDER_SHOCK, MOVE_GROWL, MOVE_QUICK_ATTACK, MOVE_LEER},
        .itemTableId = BATTLE_FRONTIER_ITEM_MENTAL_HERB,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    [FALLARBOR_TENT_MON_POOCHYENA] = {
        .species = SPECIES_POOCHYENA,
        .moves = {MOVE_HYPNOSIS, MOVE_LEER, MOVE_GROWL, MOVE_TACKLE},
        .itemTableId = BATTLE_FRONTIER_ITEM_LEPPA_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_NAUGHTY
    },
    [FALLARBOR_TENT_MON_KECLEON] = {
        .species = SPECIES_KECLEON,
        .moves = {MOVE_LICK, MOVE_SLASH, MOVE_TACKLE, MOVE_PSYBEAM},
        .itemTableId = BATTLE_FRONTIER_ITEM_WIKI_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_MODEST
    },
    [FALLARBOR_TENT_MON_MAGIKARP] = {
        .species = SPECIES_MAGIKARP,
        .moves = {MOVE_SPLASH, MOVE_TACKLE, MOVE_THRASH, MOVE_NONE},
        .itemTableId = BATTLE_FRONTIER_ITEM_DRAGON_SCALE,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FALLARBOR_TENT_MON_SOLROCK] = {
        .species = SPECIES_SOLROCK,
        .moves = {MOVE_ROCK_THROW, MOVE_FLASH, MOVE_SAND_ATTACK, MOVE_PSYWAVE},
        .itemTableId = BATTLE_FRONTIER_ITEM_HARD_STONE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_SASSY
    },
    [FALLARBOR_TENT_MON_MAKUHITA] = {
        .species = SPECIES_MAKUHITA,
        .moves = {MOVE_AGILITY, MOVE_COMET_PUNCH, MOVE_QUICK_ATTACK, MOVE_MEGA_PUNCH},
        .itemTableId = BATTLE_FRONTIER_ITEM_BLACK_BELT,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_MACHOKE] = {
        .species = SPECIES_MACHOKE,
        .moves = {MOVE_COUNTER, MOVE_COUNTER, MOVE_HARDEN, MOVE_FOCUS_ENERGY},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_NAIVE
    },
    [FALLARBOR_TENT_MON_NINCADA] = {
        ...
        .moves = {MOVE_FURY_SWIPES, MOVE_HARDEN, MOVE_SAND_ATTACK, MOVE_DIG},
        .itemTableId = BATTLE_FRONTIER_ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_SERIOUS
    },
    [FALLARBOR_TENT_MON_BEAUTIFLY] = {
        .species = SPECIES_BEAUTIFLY,
        .moves = {MOVE_FLASH, MOVE_RECOVER, MOVE_HARDEN, MOVE_MEGA_DRAIN},
        .itemTableId = BATTLE_FRONTIER_ITEM_BRIGHT_POWDER,
    ...
    [FALLARBOR_TENT_MON_DUSTOX] = {
        .species = SPECIES_DUSTOX,
        .moves = {MOVE_RECOVER, MOVE_HARDEN, MOVE_POISON_STING, MOVE_PSYBEAM},
        .itemTableId = BATTLE_FRONTIER_ITEM_FOCUS_BAND,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SPEED | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_DOCILE
    },
    [FALLARBOR_TENT_MON_ILLUMISE] = {
        .species = SPECIES_ILLUMISE,
        .moves = {MOVE_METRONOME, MOVE_CONFUSE_RAY, MOVE_RECOVER, MOVE_LOVELY_KISS},
        .itemTableId = BATTLE_FRONTIER_ITEM_SALAC_BERRY,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_VOLBEAT] = {
        .species = SPECIES_VOLBEAT,
        .moves = {MOVE_TACKLE, MOVE_RECOVER, MOVE_PSYBEAM, MOVE_GROWTH},
        .itemTableId = BATTLE_FRONTIER_ITEM_LEPPA_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_NINJASK_1] = {
        .species = SPECIES_NINJASK,
        .moves = {MOVE_DOUBLE_TEAM, MOVE_HARDEN, MOVE_DIG, MOVE_SAND_ATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_PETAYA_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SPEED | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_TIMID
    },
    [FALLARBOR_TENT_MON_NINJASK_2] = {
        .species = SPECIES_NINJASK,
        .moves = {MOVE_SWORDS_DANCE, MOVE_CUT, MOVE_FURY_SWIPES, MOVE_LEECH_LIFE},
        .itemTableId = BATTLE_FRONTIER_ITEM_SILVER_POWDER,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_ARON_1] = {
        .species = SPECIES_ARON,
        .moves = {MOVE_SCRATCH, MOVE_HARDEN, MOVE_THUNDERBOLT, MOVE_SCREECH},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_LONELY
    },
    [FALLARBOR_TENT_MON_ARON_2] = {
        .species = SPECIES_ARON,
        .moves = {MOVE_SWIFT, MOVE_SCRATCH, MOVE_HARDEN, MOVE_SAND_ATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_GENTLE
    },
    [FALLARBOR_TENT_MON_ELECTRIKE] = {
        .species = SPECIES_ELECTRIKE,
        .moves = {MOVE_BITE, MOVE_THUNDER_WAVE, MOVE_GROWL, MOVE_QUICK_ATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_SEA_INCENSE,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_HASTY
    },
    [FALLARBOR_TENT_MON_MAGNEMITE] = {
        .species = SPECIES_MAGNEMITE,
        .moves = {MOVE_THUNDER_WAVE, MOVE_SUPERSONIC, MOVE_HARDEN, MOVE_THUNDER_SHOCK},
        .itemTableId = BATTLE_FRONTIER_ITEM_MAGNET,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    [FALLARBOR_TENT_MON_VOLTORB] = {
        .species = SPECIES_VOLTORB,
        .moves = {MOVE_THUNDER_WAVE, MOVE_THUNDER_SHOCK, MOVE_SCREECH, MOVE_SONIC_BOOM},
        .itemTableId = BATTLE_FRONTIER_ITEM_ASPEAR_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    [FALLARBOR_TENT_MON_WHISMUR] = {
        .species = SPECIES_WHISMUR,
        .moves = {MOVE_REST, MOVE_REST, MOVE_HYPER_BEAM, MOVE_LOVELY_KISS},
        .itemTableId = BATTLE_FRONTIER_ITEM_LAX_INCENSE,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_LOUDRED] = {
        .species = SPECIES_LOUDRED,
        .moves = {MOVE_STOMP, MOVE_REST, MOVE_SCREECH, MOVE_SCREECH},
        .itemTableId = BATTLE_FRONTIER_ITEM_CHESTO_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_LINOONE_2] = {
        .species = SPECIES_LINOONE,
        .moves = {MOVE_FURY_SWIPES, MOVE_SAND_ATTACK, MOVE_THUNDERBOLT, MOVE_GROWL},
        .itemTableId = BATTLE_FRONTIER_ITEM_MAGNET,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    [FALLARBOR_TENT_MON_MIGHTYENA] = {
        .species = SPECIES_MIGHTYENA,
        .moves = {MOVE_SAND_ATTACK, MOVE_GROWL, MOVE_CONFUSE_RAY, MOVE_SWIFT},
        .itemTableId = BATTLE_FRONTIER_ITEM_KINGS_ROCK,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_JOLLY
    },
    [FALLARBOR_TENT_MON_SWABLU] = {
        .species = SPECIES_SWABLU,
        .moves = {MOVE_TAKE_DOWN, MOVE_SING, MOVE_GROWL, MOVE_LIGHT_SCREEN},
        .itemTableId = BATTLE_FRONTIER_ITEM_FOCUS_BAND,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FALLARBOR_TENT_MON_SKARMORY] = {
        .species = SPECIES_SKARMORY,
        .moves = {MOVE_AGILITY, MOVE_WING_ATTACK, MOVE_SAND_ATTACK, MOVE_DISABLE},
        .itemTableId = BATTLE_FRONTIER_ITEM_METAL_COAT,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_BOLD
    },
    ...
    [FALLARBOR_TENT_MON_WINGULL] = {
        .species = SPECIES_WINGULL,
        .moves = {MOVE_WING_ATTACK, MOVE_MIST, MOVE_DOUBLE_TEAM, MOVE_SUPERSONIC},
        .itemTableId = BATTLE_FRONTIER_ITEM_RAWST_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    [FALLARBOR_TENT_MON_PELIPPER] = {
        .species = SPECIES_PELIPPER,
        .moves = {MOVE_GUST, MOVE_ICE_BEAM, MOVE_DOUBLE_TEAM, MOVE_WATER_GUN},
        .itemTableId = BATTLE_FRONTIER_ITEM_DRAGON_FANG,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_BARBOACH] = {
        .species = SPECIES_BARBOACH,
        .moves = {MOVE_THUNDER_SHOCK, MOVE_WATER_GUN, MOVE_EARTHQUAKE, MOVE_WATER_GUN},
        .itemTableId = BATTLE_FRONTIER_ITEM_LIECHI_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    [FALLARBOR_TENT_MON_WAILMER] = {
        .species = SPECIES_WAILMER,
        .moves = {MOVE_WATER_GUN, MOVE_MIST, MOVE_SPLASH, MOVE_GROWL},
        .itemTableId = BATTLE_FRONTIER_ITEM_KINGS_ROCK,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_QUIET
    },
    [FALLARBOR_TENT_MON_MARILL] = {
        .species = SPECIES_MARILL,
        .moves = {MOVE_DEFENSE_CURL, MOVE_TACKLE, MOVE_BUBBLE_BEAM, MOVE_LOVELY_KISS},
        .itemTableId = BATTLE_FRONTIER_ITEM_HARD_STONE,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_GOLDEEN_1] = {
        .species = SPECIES_GOLDEEN,
        .moves = {MOVE_WATERFALL, MOVE_MIST, MOVE_THRASH, MOVE_HARDEN},
        .itemTableId = BATTLE_FRONTIER_ITEM_GANLON_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_HASTY
    },
    [FALLARBOR_TENT_MON_GOLDEEN_2] = {
        .species = SPECIES_GOLDEEN,
        .moves = {MOVE_REST, MOVE_HORN_DRILL, MOVE_REST, MOVE_SUPERSONIC},
        .itemTableId = BATTLE_FRONTIER_ITEM_MENTAL_HERB,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_CAREFUL
    },
    [FALLARBOR_TENT_MON_TRAPINCH] = {
        .species = SPECIES_TRAPINCH,
        .moves = {MOVE_TACKLE, MOVE_SAND_ATTACK, MOVE_LOVELY_KISS, MOVE_STRENGTH},
        .itemTableId = BATTLE_FRONTIER_ITEM_MAGO_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_BALTOY] = {
        .species = SPECIES_BALTOY,
        .moves = {MOVE_SELF_DESTRUCT, MOVE_SAND_ATTACK, MOVE_TACKLE, MOVE_MIMIC},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
    ...
    [FALLARBOR_TENT_MON_GRAVELER] = {
        .species = SPECIES_GRAVELER,
        .moves = {MOVE_ROCK_SLIDE, MOVE_DEFENSE_CURL, MOVE_EARTHQUAKE, MOVE_SAND_ATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_HARD_STONE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_SANDSHREW] = {
        .species = SPECIES_SANDSHREW,
        .moves = {MOVE_WRAP, MOVE_SAND_ATTACK, MOVE_DOUBLE_TEAM, MOVE_MEGA_PUNCH},
        .itemTableId = BATTLE_FRONTIER_ITEM_SOFT_SAND,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_JOLLY
    },
    [FALLARBOR_TENT_MON_SWALOT] = {
        .species = SPECIES_SWALOT,
        .moves = {MOVE_HYPNOSIS, MOVE_DISABLE, MOVE_PIN_MISSILE, MOVE_SLUDGE},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_BRAVE
    },
    [FALLARBOR_TENT_MON_SHROOMISH] = {
        .species = SPECIES_SHROOMISH,
        .moves = {MOVE_HEADBUTT, MOVE_SPORE, MOVE_CONFUSE_RAY, MOVE_LEECH_SEED},
        .itemTableId = BATTLE_FRONTIER_ITEM_QUICK_CLAW,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_IMPISH
    },
    [FALLARBOR_TENT_MON_KIRLIA] = {
        .species = SPECIES_KIRLIA,
        .moves = {MOVE_HYPNOSIS, MOVE_GROWL, MOVE_LOVELY_KISS, MOVE_DREAM_EATER},
        .itemTableId = BATTLE_FRONTIER_ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_LOMBRE] = {
        .species = SPECIES_LOMBRE,
        .moves = {MOVE_METRONOME, MOVE_WATER_GUN, MOVE_MIST, MOVE_FLASH},
        .itemTableId = BATTLE_FRONTIER_ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_BASHFUL
    },
    [FALLARBOR_TENT_MON_NUZLEAF] = {
        .species = SPECIES_NUZLEAF,
        .moves = {MOVE_METRONOME, MOVE_DISABLE, MOVE_CONFUSE_RAY, MOVE_REST},
        .itemTableId = BATTLE_FRONTIER_ITEM_CHESTO_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_CACNEA] = {
        .species = SPECIES_CACNEA,
        .moves = {MOVE_SAND_ATTACK, MOVE_PIN_MISSILE, MOVE_CONFUSE_RAY, MOVE_LEECH_SEED},
        .itemTableId = BATTLE_FRONTIER_ITEM_BRIGHT_POWDER,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SPEED | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    }
